...
{
    //[Authorize(Users = "will.silver@hotmail.com")] Agora as permissões estão em Global.asax
    public class ProdutoController : Controller
    {
        private SistemaLojaContext db = new SistemaLojaContext();

        [AllowAnonymous] //A allowAnonymous abaico do [Authorize]
                         //deixa que com que seja possivel não logados visualizarem
                         //as informações, mas para editadas precisa de lopgin

        // GET: Produto
        [Authorize(Roles = "View")] //Pega a autorização libetada em em Global.asas
